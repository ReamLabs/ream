...
pub async fn handle_req_resp_message(peer_id: PeerId, stream_id: u64, connection_id: ConnectionId, message: RequestMessage, beacon_chain: &BeaconChain, p2p_sender: &P2PSender, ream_db: &ReamDB) {
    match message {
